...
class BankAccRecStatement(models.Model):
    ...
    def action_process(self):
        ...
        for statement in self:
            ...
            for statement_line in statement_line_recordset:
                ...
                #print('reconciled move line=', statement_line.move_line_id.move_id.name)
                #print('reconciled=' + str(cleared_bank_account))
    ...
    def onchange_account_id(self):
        ...
        if self.ending_date and self.account_id:
            # Bug - TS
            if self.credit_move_line_ids:
                self.credit_move_line_ids = False
            if self.debit_move_line_ids:
