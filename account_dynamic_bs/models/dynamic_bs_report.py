    ...
    def get_report_values(self, docids, data=None):
        ...
        if data['form'].get('filter_cmp') == 'filter_date':
            ...
            if data['form'].get('date_from_cmp', ''):
                comparison_context['date_to'] = datetime.strptime(data['form'].get('date_to_cmp', False), date_format).strftime('%Y-%m-%d')
            if data['form'].get('date_from_cmp', ''):
                comparison_context['date_from'] = datetime.strptime(data['form'].get('date_from_cmp', False), date_format).strftime('%Y-%m-%d')
        else:
