...
class ReportAgedPartnerBalance12(models.AbstractModel):
    ...
    _name = 'report.scs_account_report.report_agedpartnerbalance'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        movelines, total, dummy = self.with_context(ctx)._get_partner_move_lines(account_type, date_from, target_move, data['form']['period_length'])
        return {
            'doc_ids': self.ids,
            'doc_model': model,
            'data': data['form'],
