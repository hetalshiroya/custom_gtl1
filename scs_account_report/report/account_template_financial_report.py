...
class AccountBalanceInherit(models.AbstractModel):
    _name = "report.scs_account_report.financial_report_balance_full_temp"
...
class AccountBalanceInheritQtr(models.AbstractModel):
    _name = "report.scs_account_report.account_full_qtr_balance_cols"
...
class AccountBalanceInheritTwlv(models.AbstractModel):
    _name = "report.scs_account_report.account_full_13_balance_cols"
