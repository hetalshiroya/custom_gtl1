...
{
    'name' : 'Account Reports Balance Profit Loss',
    'summary': '''Standard Account Reports of Balance Sheet, Profit and Loss, Trial Balance, Partner Ledger, Partner Aging report
     Customer and Supplier Aging report, Tax Report, Journal Audit Report with pdf and excel formats with multiple filters''',
    'version': '12.0.1.0.1',
    'description': '''Standard Account Reports of Balance Sheet, Profit and Loss, Trial Balance, Partner Ledger, Partner Aging report
     Customer and Supplier Aging report, Tax Report, Journal Audit Report with pdf and excel formats with multiple filters''',
    'category': 'Accounting',
