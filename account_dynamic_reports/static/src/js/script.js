...
'data': {'js_data':data},
'context': {'active_model':'ins.analytic.report',
'landscape':1,
'from_js': true
},
...
view_mode: 'tree',
res_model: res_model,
views: [[view_id || false, 'list']],
domain: [['id', 'in', res_id.split(',')]],
target: 'current',
context: context,
};
self.do_notify(_("Redirected"), "Window has been redirected");
...
redirect_to_document('account.analytic.line', $(event.currentTarget).data('move-id'));
},
update_with_filter : function(event){
event.preventDefault();
var self = this;
